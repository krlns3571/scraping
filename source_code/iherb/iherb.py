...
if __name__ == '__main__':
    ...
    urls = df_from_excel['예시링크'].values.tolist()
    for url in urls:
        params = {
            'productId': '82846',
            # 'pageSize': '2',
        ...
        response = requests.get('https://catalog.app.iherb.com/recommendations/freqpurchasedtogether', params=params,
                                headers=headers)

        sele_url = json.loads(response.text)['originProduct']['url']
